...
require (
	...
	github.com/catalystcommunity/go-scheduler v1.1.1
	github.com/catalystcommunity/grpc-base-go v1.0.6
	github.com/catalystcommunity/notifo-client-go v1.0.0
	github.com/catalystcommunity/protos-go-notifications v1.0.2
